...
# test_quote.py - unit tests for strings quoting
#
...
class QuotingTestCase(ConnectingTestCase):
    ...
    This tests case checks that the E'' quotes are used whenever they are
    ...
    def test_unicode(self):
        ...
        if server_encoding != "UTF8":
            return self.skipTest(
                "Unicode tests skipped since server encoding is %s"
                % server_encoding)
...
class TestStringAdapter(ConnectingTestCase):
    def test_encoding_default(self):
        ...
        # NOTE: we can't really tests an encoding different from utf8, because
    ...
    def test_set_encoding(self):
        ...
        # we tests with is utf8, otherwise the encoding chosen by PQescapeString
